...
set label 1 "\\large{$E_B=4.9$~MeV}" at 50,100
...
plot 'bu_17f_300.dat' u 4:5:6 w yerrorbars ls 2   t 'Inclusive', '' u 4:7:8 w yerrorbars ls 4   t 'Exclusive'
