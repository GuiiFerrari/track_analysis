...
set label 1 "\\large{$E_B=26.3$~MeV}" at 50,250
...
plot 'bu_17f_100.dat' u 4:5:6 w yerrorbars ls 2   t 'Inclusive', '' u 4:7:8 w yerrorbars ls 4   t 'Exclusive'
