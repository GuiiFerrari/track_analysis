...
set xlabel "\\large{ $E_\\text{c.m.}$ [MeV]}" 
#unset xlabel
#set xtics format ''
set mxtics 5
set mytics 5
...
plot 'ener_17f_bu.dat' u 3:5:4:6 w xyerrorbars ls 2   t 'Inclusive', '' u 3:7:4:8 w xyerrorbars ls 4   t 'Exclusive'
